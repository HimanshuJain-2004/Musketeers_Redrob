...
# Add project root to sys.path so modeling module can be found
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../..')))
from modeling.labeling.build_prompt import build_batch_prompt
...
# ---------------------------------------------------------
CONFIG_DIR = 'config'
ARTIFACTS_DIR = 'modeling/artifacts'
...
class Evaluator:
    def __init__(self):
        ...
        with open('modeling/prompts/system_prompt.txt', 'r', encoding='utf-8') as f:
            self.system_prompt = f.read()
        with open('modeling/prompts/job_description.txt', 'r', encoding='utf-8') as f:
            self.job_description = f.read()
        with open('modeling/prompts/candidate_prompt.txt', 'r', encoding='utf-8') as f:
            self.candidate_prompt_template = f.read()
        with open('feature_engineering/artifacts/jd_requirements.json', 'r', encoding='utf-8') as f:
