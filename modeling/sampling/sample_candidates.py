...
JAIN_DIR = os.path.join(WORKSPACE_ROOT, 'modeling')
ARTIFACTS_DIR = os.path.join(JAIN_DIR, 'artifacts')

# Ensure output directory exists
os.makedirs(ARTIFACTS_DIR, exist_ok=True)

print("Loading feature_engineering parquet files...")
cand_features = pd.read_parquet(os.path.join(WORKSPACE_ROOT, 'feature_engineering/artifacts/candidate_features.parquet'))
behav_features = pd.read_parquet(os.path.join(WORKSPACE_ROOT, 'feature_engineering/artifacts/behavior_features.parquet'))
sem_scores = pd.read_parquet(os.path.join(WORKSPACE_ROOT, 'feature_engineering/artifacts/semantic_scores.parquet'))
