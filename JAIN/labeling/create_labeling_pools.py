...
def main():
    ...
    input_parquet = 'JAIN/artifacts/sampled_candidates.parquet'
    ...
    lookup_path = 'JAIN/artifacts/original_candidate_lookup.jsonl'
    ...
    final_export.to_parquet('JAIN/artifacts/labeling_pool_3000.parquet', index=False)
    final_export.to_csv('JAIN/artifacts/labeling_pool_3000.csv', index=False)
    ...
    with open('JAIN/artifacts/labeling_pool_report.md', 'w') as f:
        f.write('\n'.join(report_lines))
